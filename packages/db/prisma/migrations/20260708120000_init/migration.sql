...
-- CreateEnum
CREATE TYPE "presenter_status" AS ENUM ('pending', 'ready', 'failed');
...
CREATE TABLE "presenters" (
    ...
    "status" "presenter_status" NOT NULL DEFAULT 'pending',
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE INDEX "presenters_user_id_idx" ON "presenters"("user_id");
...
-- AddForeignKey
ALTER TABLE "videos" ADD CONSTRAINT "videos_presenter_id_fkey" FOREIGN KEY ("presenter_id") REFERENCES "presenters"("id") ON DELETE SET NULL ON UPDATE CASCADE;
