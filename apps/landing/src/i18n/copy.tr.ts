...
export const copy: Copy = {
  ...
  heroDemo: {
    ...
    /* Berkan'ın yazdığı metin. Videonun okuduğu senaryo bu — reklam dili, ikinci tekil şahıs. */
    script: "Sunuculu tanıtım videon dakikalar içinde hazır! Yüzlerce sunucu ve ses seçeneği senin için! Ücretsiz demo için web sitemizi ziyaret edebilirsin.",
