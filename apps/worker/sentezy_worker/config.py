...
class Config:
    ...
    # Base URL of the reel renderer (POST /render-reel). Unset → local Remotion CLI render (dev, no cloud deploy).
    reel_renderer_url: str | None
...
def load_config() -> Config:
    ...
    return Config(
        ...
        reel_renderer_url=_get("REEL_RENDERER_URL"),
        is_dev=is_dev,
    )
